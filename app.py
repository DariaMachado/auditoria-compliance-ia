...
st.set_page_config(page_title="Auditor de Compliance IA", page_icon="🛡️")
st.title("🛡️ Auditor Digital de Contratos")
...
uploaded_file = st.file_uploader("Arraste o contrato em PDF aqui", type="pdf")
...
if uploaded_file and api_key:
    ...
    if st.button("Executar Auditoria de Compliance"):
        with st.spinner("A IA está analisando as cláusulas..."):
            prompt = f"""
            Você é um Auditor de Compliance sênior. Analise o contrato abaixo com base na Lei 14.133/2021.
